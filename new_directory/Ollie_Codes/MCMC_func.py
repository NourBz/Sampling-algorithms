...
def lprior_uniform(param, param_low_val = 30, param_high_val = 100):
    """
...
def MCMC_run(data_dl, delta_dl, param_start,  printerval = 5000, H0_var_prop = 0.05,  Ntotal = 50000, burnin = 0, **kwargs):
    """
